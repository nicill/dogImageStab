...
int main(int argc, char **argv)
{
    ...
    for(size_t i=0; i < prev_to_cur_transform.size(); i++) {
        ...
        // TEMP: Print the trajectory aka "difference"
        printf("Trajectory: %f, %f, %f; Sum: %f", x, y, a, x+y+a);
    }
...
//    Mat T(2,3,CV_64F);
//
//    int vert_border = HORIZONTAL_BORDER_CROP * previous.rows / previous.cols; // get the aspect ratio correct
//
//    k=0;
...
//
//        // Resize cur2 back to current size, for better side by side comparison
//        resize(cur2, cur2, current.size());
//
//        // Now draw the original and stablised side by side for coolness
//        Mat canvas = Mat::zeros(current.rows, current.cols*2+10, current.type());
//
//        current.copyTo(canvas(Range::all(), Range(0, cur2.cols)));
